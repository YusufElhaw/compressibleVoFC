...
Foam::compressibleInterPhaseTransportModelC::compressibleInterPhaseTransportModelC
(
    ...
    const compressibleTwoPhaseVoFMixtureC& mixture
)
:
...
Foam::compressibleInterPhaseTransportModelC::divDevTau
(
    volVectorField& U
) const
{
...
void Foam::compressibleInterPhaseTransportModelC::predict()
{
    if (twoPhaseTransport_)
    {
...
void Foam::compressibleInterPhaseTransportModelC::correct()
{
    if (twoPhaseTransport_)
    {
