...
namespace solvers
{
    defineTypeNameAndDebug(compressibleVoFC, 0);
    addToRunTimeSelectionTable(solver, compressibleVoFC, fvMesh);
}
}
...
bool Foam::solvers::compressibleVoFC::read()
{
...
Foam::solvers::compressibleVoFC::compressibleVoFC(fvMesh& mesh)
:
    twoPhaseVoFSolver
    (
        mesh,
        autoPtr<twoPhaseVoFMixture>(new compressibleTwoPhaseVoFMixtureC(mesh))
    ),

    mixture_
    (
        refCast<compressibleTwoPhaseVoFMixtureC>(twoPhaseVoFSolver::mixture)
    ),
...
Foam::solvers::compressibleVoFC::~compressibleVoFC()
{}


// * * * * * * * * * * * * * * Member Functions  * * * * * * * * * * * * * * //

void Foam::solvers::compressibleVoFC::prePredictor()
{
...
void Foam::solvers::compressibleVoFC::momentumTransportPredictor()
{
    momentumTransport.predict();
}


void Foam::solvers::compressibleVoFC::thermophysicalTransportPredictor()
{
    thermophysicalTransport.predict();
}


void Foam::solvers::compressibleVoFC::momentumTransportCorrector()
{
    momentumTransport.correct();
}


void Foam::solvers::compressibleVoFC::thermophysicalTransportCorrector()
{
